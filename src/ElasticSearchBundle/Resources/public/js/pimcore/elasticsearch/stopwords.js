pimcore.registerNS("saltid.elasticsearch.setting.stopwords");
saltid.elasticsearch.setting.stopwords = Class.create({
    onFileSystem: false,
    data: {},
    ...
    load: function () {
        ...
        Ext.Ajax.request({
            url: "/saltid/elasticsearch/stopwords",
    ...
    activate: function () {
        ...
        tabPanel.setActiveItem("saltid_elasticsearch_stopwords");
    },
    ...
    getTabPanel: function () {
        ...
        if (!this.panel) {
            this.panel = new Ext.Panel({
                id: "saltid_elasticsearch_stopwords",
                title: t('menustopwordsTokenFilter'),
            ...
            this.panel.on("destroy", function () {
                pimcore.globalmanager.remove("stopwords");
            }.bind(this));
